...
metadata[KEYS.GET_SUGGEST_CONSULTANT] = {
  method:'GET',
  endPoint: ENDPOINTS.CONSULT_API,
  apiRoute: API_ROUTE.SUGGEST_CONSULTANT,
  failureAction: ACTIONS.GET_SUGGEST_CONSULTANT_FAILE,
  successAction: ACTIONS.GET_SUGGEST_CONSULTANT_SUCCESS
};
