...
import {ACTION_KEY as KEYS, ACTION_ATTR as ATTRS, USER_PROFILE, REDUX_ACTIONS} from '../../constants/apiSagaConstant'
...
const mapDispatchToProps = (dispatch) => ({
    actions:{
        ...
        profileUpdated:bindActionCreators(actionCreateStoreUpdateFactory(REDUX_ACTIONS.PROFILE_UPDATED,ATTRS.DATA),dispatch),
    }
});
